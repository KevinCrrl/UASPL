...
frases = {
    ...
    "estado-servicios": "status-services",
    ...
    "Seguro de que deseas eliminar todos los archivos detectados como maliciosos?": "Are you sure you want to delete all infected files?",
...
status-services: Shows the status of the ClamAV services.
